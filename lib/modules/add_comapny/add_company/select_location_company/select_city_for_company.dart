...
class SelectCityForCompany extends StatelessWidget {
  const SelectCityForCompany({Key? key}) : super(key: key);
  ...
  Widget buildLocationItem(CityData data ,context) {
    ...
    return InkWell(
      onTap: () {
        ElMahalCubit.get(context).cityName = name!;
        ElMahalCubit.get(context).cityId!.add(data.id!);
